...
We are defining a function, so we need to use \clocode{defn}. It takes one parameter which is a collection. It is common to name a collection parameter \clocode{coll}, so we will follow this convention. 

\elenacomment{finish the example}
