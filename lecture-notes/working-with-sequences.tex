...
\elenacomment{talk about vector? and list?}

Just like there is a way to create sequences from collections (such as vectors and lists) using \clocode{seq}, there is a way to create a list or a vector from any sequence. \elenacomment{more complicated than that: list takes multiple arguments, vec takes a single argument that's a sequence}
