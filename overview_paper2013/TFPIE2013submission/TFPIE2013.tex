...
It is clear that in order to deal with these issues, one needs to use an approach other than a {\tt try/catch} block in {\tt main}. We discuss a possible way of deaking with these issues in Section~\ref{subsec:envt}.
