...
Clojure projects are managed by a tool called {\tt leiningen}. We need to include beginner-friendly error handling and functions. Program code will be written in a file and typed into REPL. 
