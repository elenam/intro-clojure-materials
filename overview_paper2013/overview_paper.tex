...
In this work we explore incorporating Clojure into an introductory Computer Science course typical of a Computer Science program in a small 4-year college. A typical such course, in our experience, has 30-40 students, has about 3.5 contact hours per week that include lecture and lab time and other activities, e.g. group discussions. Students in the class include CS majors/minors, undecided students with  interest in CS, and those taking it to satisfy an elective requirement for another discipline (e.g. math) or as a general education course. The majority of the students (even those who start a CS major) do not have any prior programming experience and very little understanding of the process of computing. 

The course focuses on general problem solving and its specifics as related to computer science. Students work on understanding a problem requirements and gradually develop solutions in a programming language, with an emphasis on effective design and testing strategies. In the process they learn about language syntax and behavior, key programming concepts, such as conditionals and functions, data representation in a program, and similar introductory-level concepts. Mastering the concept of recursion is one of the key learning objectives in the course. Towards the end of the course students develop their own implementations of simple searching and sorting algorithms and are informally introduced to the concept of big-O. The course exercises include both concrete assignments and open-ended projects that include graphical and simple game development. Students work in groups which promotes inter-personal communication and code style that communicates code intention. 
