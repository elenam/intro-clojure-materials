...
In this work we explore incorporating Clojure into an introductory Computer Science course typical of a Computer Science program in a small 4-year college. A typical such course, in our experience, has 25-35 students, has about 3.5 contact hours that include both lecture and lab time (in our experience, ``lecture'' time also includes interactive program code development on the shared screen, some group and all-class discussion, some paper exercise time, and other activities). Students in the class include CS majors/minors, undecided students with  interest in CS, and those taking it to satisfy an elective requirement for other disciplines (e.g. math) or a general education requirement (in the case of our school, a requirement in mathematical and symbolic reasoning which may also be satisfied by a math or statistics course). The majority of the students (even those who start a CS major) do not have any prior programming experience. Those continuing in the CS program would take a version of a discrete mathematics class as their second CS  course and Data Structures (in Java) as the next course that involves programming. 
